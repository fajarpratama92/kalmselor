class UserSubscriptionList {
  ...
  @override
  String toString() {
    return "id : $id , subscriptionId : $subscriptionId , userId : $userId , isTrial : $isTrial , name : $name , status : $status , type : $type , startAt : $startAt , endAt : $endAt , lastExtendAt : $lastExtendAt , voucherId : $voucherId , promoId : $promoId , methodPayment : $methodPayment , midtransResponse : $midtransResponse , otherResponse : $otherResponse , flagUserReadTnc : $flagUserReadTnc , createdAt : $createdAt , updatedAt : $updatedAt";
  }
}
